...
var AllusersComponent = /** @class */ (function () {
    function AllusersComponent(http, router, store) {
        this.http = http;
        this.router = router;
        this.store = store;
        var data = this.store.get('user');
        if (!data)
            return;
        this.token = data.token;
        this.id = data.id;
    }
    AllusersComponent.prototype.clickHandler = function (user) {
        var _this = this;
        this.http.gotoRoom(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, user, { token: this.token })).subscribe(function (data) {
            if (data.status == 200)
                _this.router.navigate(['chat', { room: data.room, name: data.name }]);
        });
    };
    AllusersComponent.prototype.ngOnInit = function () {
        var _this = this;
        if (this.id) {
            this.http.recentChats({ id: this.id }).subscribe(function (data) {
                if (data)
                    _this.recent = data;
            });
        }
...
/* harmony import */ var _ant_design_icons_angular_icons__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @ant-design/icons-angular/icons */ "./node_modules/@ant-design/icons-angular/fesm5/ant-design-icons-angular-icons.js");
/* harmony import */ var ng_zorro_antd_icon__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ng-zorro-antd/icon */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-icon.js");
...
var antDesignIcons = _ant_design_icons_angular_icons__WEBPACK_IMPORTED_MODULE_21__;
...
var AuthService = /** @class */ (function () {
    function AuthService(store, http, router) {
        ...
        if (!this.token)
            return;
        this.http.isLoggedIn(this.token).subscribe(function (response) {
            if (response.status == 200)
                return _this.loggedIn.next(response.loggedin);
            _this.store.remove('user');
...
var ChatRoomComponent = /** @class */ (function () {
    function ChatRoomComponent(realtime, store, parameters, http) {
    ...
    ChatRoomComponent.prototype.ngOnInit = function () {
        ...
        this.http.getMessages({ room: this.roomId }).subscribe(function (data) {
            if (data.status == 200)
                _this.chats = data.messages;
        });
    };
...
var FormComponent = /** @class */ (function () {
    function FormComponent(fb, http, router) {
        this.fb = fb;
        this.http = http;
        this.router = router;
    }
    FormComponent.prototype.submitForm = function () {
        ...
        this.message = '';
        this.type = '';
        var _a = this.validateForm.controls, email = _a.email, userName = _a.userName, password = _a.password;
        ...
        this.http.signup({ email: email.value, userName: userName.value, password: password.value })
            ...
            _this.type = 'error';
            if (data.emailFlag)
                _this.validateForm.controls['email'].setErrors({ 'incorrect': true });
            if (data.userNameFlag)
                _this.validateForm.controls['userName'].setErrors({ 'incorrect': true });
            if (data.passwordFlag)
                _this.validateForm.controls['password'].setErrors({ 'incorrect': true });
        });
    };
    FormComponent.prototype.navigateTo = function () {
        var _this = this;
        this.type = 'success';
...
var HideRecentPipe = /** @class */ (function () {
    function HideRecentPipe() {
    }
    HideRecentPipe.prototype.transform = function (value, input) {
        if (input)
            return [];
        return value;
    };
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.gotoRoom = function (data) {
        var name = data.name, _id = data._id, userName = data.userName;
        return this.http.post('api/room', { name: name, _id: _id, userName: userName }, {
            headers: {
                authentication: data.token
            }
        });
    };
    HttpService.prototype.getMessages = function (data) {
        return this.http.post('api/messages', data);
    };
    HttpService.prototype.isLoggedIn = function (data) {
    ...
    HttpService.prototype.recentChats = function (id) {
...
var InputComponent = /** @class */ (function () {
    ...
    InputComponent.prototype.send = function () {
        if (!this.message)
            return;
...
var JoinComponent = /** @class */ (function () {
    function JoinComponent(router, realtime, store) {
        this.router = router;
        this.realtime = realtime;
        this.store = store;
        this.user = {
    ...
    JoinComponent.prototype.joinHandler = function () {
...
var LocalstorageService = /** @class */ (function () {
    ...
    LocalstorageService.prototype.get = function (item) {
        return JSON.parse(localStorage.getItem(item));
    };
    LocalstorageService.prototype.set = function (item, value) {
        localStorage.setItem(item, JSON.stringify(value));
    };
    LocalstorageService.prototype.remove = function (item) {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, http, router, store, auth) {
        this.fb = fb;
        this.http = http;
        this.router = router;
        this.store = store;
    ...
    LoginComponent.prototype.submitForm = function () {
        ...
        this.message = '';
        this.type = '';
        var _a = this.validateForm.controls, email = _a.email, password = _a.password;
        for (var i in this.validateForm.controls) {
            this.validateForm.controls[i].markAsDirty();
            this.validateForm.controls[i].updateValueAndValidity();
        }
        this.http.login({ email: email.value, password: password.value })
            ...
            _this.message = data.message;
            if (data.status == 200) {
                _this.auth.login({ name: data.name, token: data.token, id: data.id });
...
var MessagesComponent = /** @class */ (function () {
    function MessagesComponent(realtime, store) {
        this.realtime = realtime;
        this.store = store;
        this.messages = [];
    }
    MessagesComponent.prototype.ngOnInit = function () {
        ...
        this.realtime.socket.on(this.user.room, function (data) {
            _this.messages.push(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, data));
        });
    };
...
var ScrollDirective = /** @class */ (function () {
    function ScrollDirective(elem) {
        this.elem = elem;
    }
    ScrollDirective.prototype.ngDoCheck = function () {
...
var SearchPipe = /** @class */ (function () {
    ...
    SearchPipe.prototype.transform = function (value, search) {
        ...
        if (!search)
            return value;
        return value.filter(function (data) { return data.userName.toLocaleLowerCase().includes(search.toLocaleLowerCase()); });
    };
...
/* harmony import */ var ng_zorro_antd_grid__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ng-zorro-antd/grid */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-grid.js");
/* harmony import */ var ng_zorro_antd_card__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng-zorro-antd/card */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-card.js");
/* harmony import */ var ng_zorro_antd_input__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ng-zorro-antd/input */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-input.js");
/* harmony import */ var ng_zorro_antd_alert__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ng-zorro-antd/alert */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-alert.js");
/* harmony import */ var ng_zorro_antd_list__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ng-zorro-antd/list */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-list.js");
/* harmony import */ var ng_zorro_antd_avatar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ng-zorro-antd/avatar */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-avatar.js");
/* harmony import */ var ng_zorro_antd_icon__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ng-zorro-antd/icon */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-icon.js");
/* harmony import */ var ng_zorro_antd_spin__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ng-zorro-antd/spin */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-spin.js");
